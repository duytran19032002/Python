...
MACHINE_TEMPERATURE_TOPIC = "FABLAB/Environment/Metric/Tempurature"
...
def Recreate_Data():
    ...
    Data_Gas = random.randint(80, 150)
...
def Publish_Data1():
    ...
    while True:
      ...
      #  client.publish(OPERATIOR_TOPIC1,json_messageStaffID,1,1)
        ...
        client.publish(MACHINE_TEMPURATURE_TOPIC,json_messageTempurature,1,1)
